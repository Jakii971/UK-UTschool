							...
							<?php $__currentLoopData = $pakets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="solution_card m-3">
									...
									<div class="solu_description">
											<p>Durasi : <?php echo e($paket->durasi); ?></p>
											<p>Harga : <?php echo e($paket->harga); ?></p>
											<a href="<?php echo e(route('transaksi.create', ['id' => $paket->id])); ?>" class="button">
												<button type="button" class="read_more_btn">Buat Transaksi</button>
											</a>
									</div>
								</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\uts\JAKI\UT School\uji_kompetensi\client\larapelUK\resources\views/paket/index.blade.php ENDPATH**/ ?>