...
<body>
    <div class="container">
        <div class="d-flex justify-content-center mb-4">
            <a href="<?php echo e(route('kategori-destinasi.index')); ?>" class="btn btn-primary mb-3">Kembali ke Halaman Kategori</a>
        </div>
        <div class="d-flex justify-content-center">
            ...
            <div class="card profile-card">
                <div class="card-body">
                    ...
                    <img src="https://avatar.iran.liara.run/public/boy?username=<?php echo e($userPelanggan); ?>" alt="Profile Image" class="profile-image mt-4">
                    <div class="profile-details mt-4">
                        <p><strong>Nama Pelanggan:</strong> <?php echo e(isset($userPelanggan) ? $userPelanggan : ''); ?></p>
                        <p><strong>Alamat:</strong> <?php echo e(isset($userAddress) ? $userAddress : ''); ?></p>
                        <p><strong>No Telepon:</strong> <?php echo e(isset($userPhone) ? $userPhone : ''); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="card form-card ml-4">
                <div class="card-body">
                    ...
                    <form id="formTransaksi" action="<?php echo e(route('transaksi.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <label for="user_id">ID User</label>
                            <input type="text" class="form-control" id="username" value="<?php echo e(isset($userName) ? $userName : ''); ?>" readonly>
                            <input type="text" class="form-control" name="user_id" id="user_id" value="<?php echo e(isset($userId) ? $userId : ''); ?>" hidden>
                        </div>
                        <div class="form-group">
                            <label for="paket_id">Paket</label>
                            <input type="text" class="form-control" id="paket_id" value="<?php echo e(isset($paket) ? $paket->nama_paket : ''); ?>" readonly>
                            <input type="hidden" name="paket_id" value="<?php echo e(isset($paket) ? $paket->id : ''); ?>">
                        </div>
                        <div class="form-group">
                            <label for="jumlah_harga">Jumlah Harga</label>
                            <input type="number" class="form-control" id="jumlah_harga" name="jumlah_harga" value="<?php echo e(isset($paket) ? $paket->harga : ''); ?>" readonly>
                        </div>
                        <div class="form-group">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img id="qrCodeImage" src="<?php echo e(asset('images/QR.png')); ?>" alt="QR Code" class="img-fluid">
                </div>
...
<?php /**PATH C:\Users\uts\JAKI\UT School\uji_kompetensi\client\larapelUK\resources\views/transaksi/create.blade.php ENDPATH**/ ?>