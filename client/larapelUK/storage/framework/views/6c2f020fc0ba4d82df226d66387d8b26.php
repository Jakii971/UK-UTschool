<header class="mx-0 border-bottom">
          ...
          <div class="row">
            <div class="col-md-6 text-center">
              <a class="navbar-brand" href="#"
                >TRAVELKUY <span>Architecture Agency</span></a
              >
            </div>
            <div class="col-md-6 d-md-flex justify-content-end mb-md-0 mb-3">
              <form action="#" class="searchform order-lg-last">
                <div class="shadow form-group d-flex">
                  <input
                    type="text"
...
<?php /**PATH C:\Users\uts\JAKI\UT School\uji_kompetensi\client\larapelUK\resources\views/shared/header.blade.php ENDPATH**/ ?>