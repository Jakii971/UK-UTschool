							...
							@foreach($pakets as $paket)
								<div class="solution_card m-3">
									...
									<div class="solu_description">
											...
											<a href="{{ route('transaksi.create', ['id' => $paket->id]) }}" class="button">
...
{{-- <div class="container">
        <h1 class="mt-4">Paket Destinasi</h1>
        <!-- Tombol untuk kembali ke halaman subkategori -->
        <a href="{{ url()->previous() }}" class="btn btn-primary mb-3">Kembali ke Halaman Subkategori</a>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Durasi: {{ $paket->durasi }}</p>
                            <!-- Tombol untuk membuat transaksi -->
                            <a href="{{ route('transaksi.create', ['id' => $paket->id]) }}" class="btn btn-primary">Buat Transaksi</a>
                        </div>
                    </div>
                </div>
            @endforeach
